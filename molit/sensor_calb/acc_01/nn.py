...
W3 = tf.get_variable("W3", shape=[3,3], initializer=xavier_init(3,3))
...
linear_model2 =tf.nn.sigmoid(tf.matmul(linear_model1,W2)+b2)
linear_model3 =tf.matmul(linear_model2,W3)+b3

# Cost function 
cost = tf.reduce_mean(tf.reduce_sum(tf.square(linear_model3-Y)))
